...
from axiual import fb2, global_params_dict
...
def int_ReB2(mmq1, mmu_q1, mmq2, mmu_q2):
    ...
    if global_params_dict['E01'] > 0.0:
        return 4.0 * integrate.quad(fb2.f2_1, a, b, epsabs=0.0001, epsrel=0.0001)[0]
    else:
        c = -global_params_dict['E01']
        if c == a:
            return 4.0 * integrate.quad(fb2.f2_1, a, b, points=[a, b], epsabs=0.0001, epsrel=0.0001)[0]
        else:
            return 4.0 * integrate.quad(fb2.f2_2, a, b, points=[c], epsabs=0.0001, epsrel=0.0001)[0]
