...
def int_ReB3(mmq1, mmu_q1, mmq2, mmu_q2):
    ...
    if global_params_dict['E02'] > 0.0:
        return 4.0 * integrate.quad(fb3.fB3_1, a, b, epsabs=0.0001, epsrel=0.0001)[0]
    else:
        c = -global_params_dict['E02']
        if c == a:
            return 4.0 * integrate.quad(fb3.fB3_1, a, b, points=[a, b], epsabs=0.0001, epsrel=0.0001)[0]
        else:
            return 4.0 * integrate.quad(fb3.fB3_2, a, b, points=[c], epsabs=0.0001, epsrel=0.0001)[0]
